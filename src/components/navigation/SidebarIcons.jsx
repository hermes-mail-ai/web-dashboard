...
export function InboxIcon({ className = iconClass }) {
  return (
...
export function StarIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function SendIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function DraftIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function TrashIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function PeopleIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function SettingsIcon({ className = iconClass }) {
  return (
...
export function LogoutIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function UserIcon({ className = iconClass }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
 ...
 */
export function getIcon(iconName, className = iconClass) {
  switch (iconName) {
    ...
    case 'draft': return <DraftIcon className={className} />;
