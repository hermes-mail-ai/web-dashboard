...
function ComposeToolbar({
  ...
  return (
    <div className="flex-shrink-0 flex items-center justify-between px-6 py-3 border-b border-slate-700/50 bg-slate-800/30">
      {/* Text Formatting */}
      ...
      <div className="flex items-center gap-0.5">
        <button
          ...
          className="px-2 py-1.5 hover:bg-slate-700 rounded transition-colors text-gray-400 hover:text-white text-xs font-bold"
          title="Heading 1"
        >
          H1
        </button>
      ...
      <div className="relative group">
        ...
        <div className="absolute bottom-full right-0 mb-2 px-2 py-1 bg-slate-700 text-gray-200 text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          {hasRecipients ? 'AI Compose' : 'Add a recipient to use AI compose'}
        </div>
      </div>
    </div>
  );
 ...
 */
function Divider() {
  return <div className="w-px h-8 bg-slate-600 mx-3" />;
}
